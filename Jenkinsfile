  ...
  stages {
    ...
    stage ('Building the package and archiving it in Jenkins') {
      ...
      post {
        ...
        cobertura coberturaReportFile: 'target/site/cobertura/*.xml', conditionalCoverageTargets: '70, 60, 60', failNoReports: false, failUnhealthy: false, failUnstable: false, lineCoverageTargets: '80, 70, 70', maxNumberOfBuilds: 10, methodCoverageTargets: '90, 85, 85', onlyStable: false, sourceEncoding: 'ASCII', zoomCoverageChart: false
        }
      }
    }
